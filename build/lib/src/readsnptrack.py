                            ...
                            if k[0] == 0:
                               ...
                               # print(mapstart,mapend)
                                ...
                                if  len(mapseq) ==  len(refseq):
                                    if writethereadnameornot ==1:
                                    #print(mapseq,refseq,"seqtwo")
                                        plt.text(dicreaddetailinf[readname][0],dicreaddetailinf[readname][1]-0.05,readname,fontsize=1,color="blue")
                                    for l in range(len(mapseq)):
                                        if mapseq[l] != refseq[l]:
                                            plt.text(dicreaddetailinf[readname][0]+scanedlength+l,dicreaddetailinf[readname][1],mapseq[l],fontsize=1,color="black")
                                            #print(mapseq[l],"here")
                                else:
                                    print(readname,"lengthnotread")
                                #if i.find("main") != -1:
