...
def parse_args():
    ...
    parser.add_argument('--mode', type=str,default="short", help="Types of your read you want to visualization (short/long/index/convey)")
    parser.add_argument('--rfa', type=str,default="short", help="fasta/information file for index")
    parser.add_argument('--gfa', type=str,default="short", help="gfa file need to convey in convey mode")
    parser.add_argument('--ref', type=str,default="short", help="reference selected in gfa file need to convey in convey mode")
    ...
    parser.add_argument('--pairendrange', type=int,default=300, help="The search range in the main track, default: 300")
    parser.add_argument('--pairendtheraold', type=int,default=2, help="The selected theraold in the main track, default: 2")   
    parser.add_argument('--gaingene', type=int,default=0, help="gain the gene from the gff file, default: 0")
    parser.add_argument('--readspilt', type=int,default=0, help="Display the read split information or not, default not (0) ")
    ...
    parser.add_argument('--snp', type=int,default=0, help="draw the snp information or not (interval<2000bp)") 
    ...
    parser.add_argument('--readsplitcolor', type=str,default="#FFB266", help="Colors of pair end link default:#FFB266")
    ...
    parser.add_argument('--sx', type=int,default=0, help="Size of X")
    parser.add_argument('--selfajust', type=str,default="none", help="Self ajust of X")
